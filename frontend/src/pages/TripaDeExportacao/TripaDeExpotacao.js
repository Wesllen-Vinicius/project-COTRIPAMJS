        ...
        <div class="card-body">
          <div class="row">
             <div class="col-md-2 col-sm-12">
                ...
                <input type="number" class="form-control" onChange={(e) => setTripaReta(e.target.value)}  id="tripaReta" placeholder="0"/>
             </div>
             <div class="col-md-2 col-sm-12">
               <label for="tripaTorta1c" class="form-label">Tripa Torta 1C</label>
               <input  type="number" class="form-control" onChange={(e) => setTripaTorta(e.target.value)} id="tripaTorta1c" placeholder="0"/>
             </div>
             <div class="col-md-2 col-sm-12">
               <label for="tripaTorta2c" class="form-label">Tripa Torta 2C</label>
               <input  type="number" class="form-control" id="tripaTorta2c" onChange={(e) => setTripaTorta2C(e.target.value)} placeholder="0"/>
             </div>
             <div class="col-md-1 col-sm-12">
               <label for="culatra" class="form-label">Culatra</label>
               <input type="number" class="form-control" id="culatra"  onChange={(e) => setCulatra(e.target.value)} placeholder="0"/>
             </div>
             <div class="col-md-1 col-sm-12">
               <label for="fundo" class="form-label">Fundo</label>
               <input  type="number" class="form-control" id="fundo"  onChange={(e) => setFundo(e.target.value)} placeholder="0"/>
             </div>
             <div class="col-md-2 col-sm-12">
               <label for="fundo" class="form-label">Data</label>
               <input  type="date" class="form-control" onChange={(e) => setDataDia(e.target.value)} />
             </div>
             </div>
             </div>
          ...
          <div class="row">
            <div class="col-md-1 col-sm-12">
                <input  type="button" class="btn btn-success" value="Enviar" id="enviar" onClick={cadastrarTripaExportacao} />
             </div>
             </div>
             </div>
