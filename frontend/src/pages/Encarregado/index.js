...
function Encarregado() {
  ...
  const totalSerosa =
    parseFloat(primeiro * 630) +
    parseFloat(segundo * 470) +
    parseFloat(terceiro * 320) +
    parseFloat(quarto * 170);
  const mediaSerosa = parseFloat(totalSerosa) / parseFloat(totalAbate);
  var totalTripaCozida =
    parseFloat(culatra) +
    parseFloat(abomaso) +
    parseFloat(fundo) +
    parseFloat(tripaFina) +
    parseFloat(tripaGrossa) +
    parseFloat(mocoto);
  const mediaTripaCozida =
    parseFloat(totalTripaCozida) / parseFloat(totalAbate);
  ...
  const cadastrarResumo = () => {
    axios
      .post("http://localhost:3001/api/abate", {
        ...
        unidade_abate: Encarregado_Unidade,
        bois_abate: bois,
    ...
    axios
      .post("http://localhost:3001/api/serosa", {
        ...
        data: new Date().toLocaleDateString("pt-BR"),
        encarregado: Encarregado_Nome,
        unidade_serosa: Encarregado_Unidade,
        data_dia: dataDiaria,
    ...
    axios
      .post("http://localhost:3001/api/tripaCozida", {
        culatra: culatra,
        abomaso: abomaso,
        mocoto: mocoto,
        fundo: fundo,
        ...
        encarregado: Encarregado_Nome,
        unidade_tripaCozida: Encarregado_Unidade,
        data: new Date().toLocaleDateString("pt-BR"),
        data_dia: dataDiaria,
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-2 col-sm-12">
                  <label for="abate" class="form-label">
                    Abate
                  </label>
                  <input
                ...
                <div class="col-md-2 col-sm-12">
                  <label for="boi" class="form-label">
                    Bois Abatidos
                  </label>
                  <input
                ...
                <div class="col-md-2 col-sm-12">
                  <label for="condenados" class="form-label">
                    Condenados
                  </label>
                  <input
                    onChange={(e) => setCondenados(e.target.value)}
                    type="number"
                    class="form-control"
                    id="condenados"
                    placeholder="0"
                ...
                <div class="col-md-1 col-sm-12">
                  <label for="630" class="form-label">
                    630
                  </label>
                  <input
                ...
                <div class="col-md-1 col-sm-12">
                  <label for="470" class="form-label">
                    470
                  </label>
                  <input
                ...
                <div class="col-md-1 col-sm-12">
                  <label for="320" class="form-label">
                    320
                  </label>
                  <input
                ...
                <div class="col-md-1 col-sm-12">
                  <label for="170" class="form-label">
                    170
                  </label>
                  <input
              ...
              <div class="row mgTopRow">
                <div class="col-md-1 col-sm-12">
                  <label for="mocoto" class="form-label">
                    Mocoto
                  </label>
                  <input
                    onChange={(e) => setMocoto(e.target.value)}
                    type="number"
                    class="form-control"
                    id="mocoto"
                    placeholder="0"
                ...
                <div class="col-md-1 col-sm-12">
                  <label for="abomaso" class="form-label">
                    Abomaso
                  </label>
                  <input
                    onChange={(e) => setAbomaso(e.target.value)}
                    type="number"
                    class="form-control"
                    id="abomaso"
                    placeholder="0"
                ...
                <div class="col-md-2 col-sm-12">
                  <label for="tripaGrossa" class="form-label">
                    Tripa G.
                  </label>
                  <input
                    onChange={(e) => setTpgrossa(e.target.value)}
                    type="number"
                    class="form-control"
                    id="tripaGrossa"
                    placeholder="0"
                ...
                <div class="col-md-2 col-sm-12">
                  <label for="tripaFina" class="form-label">
                    Tripa F.
                  </label>
                  <input
                    onChange={(e) => setTpfina(e.target.value)}
                    type="number"
                    class="form-control"
                    id="tripaFina"
                    placeholder="0"
                ...
                <div class="col-md-3 col-sm-12">
                  <label for="dataDiaria" class="form-label">
                    Data
                  </label>
                  <input
