  ...
  const cadastrar = () => {
    axios
      .post("http://localhost:3001/api/produtos", {
        ...
        unidade_produtos: Encarregado_Unidade,
        data_dia: dataDiaria,
        bb: bb,
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-2 col-sm-12">
                <label for="salFino" class="form-label">
                  Sal Fino
                </label>
                <input
                  onChange={(e) => setSalFino(e.target.value)}
                  type="number"
                  class="form-control"
                  id="salFino"
                  placeholder="0"
              ...
              <div class="col-md-2 col-sm-12">
                <label for="salGrosso" class="form-label">
                  Sal Grosso
                </label>
                <input
                  onChange={(e) => setSalGrosso(e.target.value)}
                  type="number"
                  class="form-control"
                  id="salGrosso"
                  placeholder="0"
              ...
              <div class="col-md-2 col-sm-12">
                <label for="metab" class="form-label">
                  Metab.
                </label>
                <input
              ...
              <div class="col-md-1 col-sm-12">
                <label for="perox" class="form-label">
                  Perox
                </label>
                <input
                  onChange={(e) => setPerox(e.target.value)}
                  type="number"
                  class="form-control"
                  id="perox"
                  placeholder="0"
              ...
              <div class="col-md-3 col-sm-12">
                ...
                <input
                  onChange={(e) => setDataProdutos(e.target.value)}
                  type="date"
                  class="form-control"
                  id="dataDiaria"
                />
